...
export function installBrowserMockIfNeeded(): void {
  ...
  const mock: SitkaApi = {
    ...
    endEventNow: async () => undefined,
    setEventBanner: async () => null,
    deleteOrg: async () => ({}),
    ...
    getUsage: async () => null,
    listMyCourses: async () => [],
    createCourse: async () => ({ error: 'unavailable in browser preview' }),
    previewCourse: async () => null,
    joinCourse: async () => ({ error: 'unavailable in browser preview' }),
    hideCourse: async () => undefined,
    orgOverview: async () => null,
    setOrgMemberRole: async () => ({ error: 'unavailable in browser preview' }),
    removeOrgMember: async () => ({ error: 'unavailable in browser preview' }),
    newOrgCodes: async () => ({ error: 'unavailable in browser preview' }),
    renameOrg: async () => ({ error: 'unavailable in browser preview' }),
    ...
    startVideoBroadcast: async () => undefined,
    stopVideoBroadcast: async () => undefined,
    ...
    readImage: async () => ({ text: '', error: 'Reading pictures needs an AI key in Settings.' }),
