...
function registerIpc(): void {
  ...
  ipcMain.handle('event:keep', () => ({ error: 'Events are kept in the online workspace.' }))
  ipcMain.handle('event:myLive', () => [])
  ...
  ipcMain.handle('org:overview', () => null)
  ipcMain.handle('org:setRole', () => ({ error: 'Organisations live on the website.' }))
  ipcMain.handle('org:remove', () => ({ error: 'Organisations live on the website.' }))
  ipcMain.handle('org:newCodes', () => ({ error: 'Organisations live on the website.' }))
  ipcMain.handle('org:rename', () => ({ error: 'Organisations live on the website.' }))
